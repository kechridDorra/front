...
class Categorie6 extends Component {
  constructor() {
    super();
  ...
  async getCategorie6() {
    try {
      ...
      console.log("categorie", categorie6);
    } catch (error) {
      // alert("test")
    }
  }
          ...
          <div class="container py-5" enctype="multipart/form-data">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent pl-0 mb-0">
                ...
                <li class="breadcrumb-item">
                  <a href="/categorie6">
                    Catégorie : <strong> {categorie6.nom}</strong>
                  </a>
                </li>
              </ol>
            </nav>
            ...
            {loading ? (
              ...
              <div class={"row"}>
                {this.state.categorie6.encheres.map(encheres =>
