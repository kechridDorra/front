...
class Categorie7 extends Component {
  constructor() {
    super();
  ...
  async getCategorie7() {
    try {
      ...
      console.log("categorie", categorie7);
    } catch (error) {
      // alert("test")
    }
  }
          ...
          <div class="container py-5" enctype="multipart/form-data">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent pl-0 mb-0">
                ...
                <li class="breadcrumb-item">
                  <a href="/categorie7">
                    Catégorie : <strong> {categorie7.nom}</strong>
                  </a>
                </li>
              </ol>
            </nav>
            ...
            {loading ? (
              ...
              <div class={"row"}>
                {this.state.categorie7.encheres.map(encheres =>
