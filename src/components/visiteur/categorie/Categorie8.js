...
class Categorie8 extends Component {
  constructor() {
    super();
  ...
  async getCategorie8() {
    try {
      ...
      console.log("categorie", categorie8);
    } catch (error) {
      // alert("test")
    }
  }
          ...
          <div class="container py-5" enctype="multipart/form-data">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent pl-0 mb-0">
                ...
                <li class="breadcrumb-item">
                  <a href="/categorie8">
                    Catégorie : <strong> {categorie8.nom}</strong>
                  </a>
                </li>
              </ol>
            </nav>
            ...
            {loading ? (
              ...
              <div class={"row"}>
                {this.state.categorie8.encheres.map(encheres =>
