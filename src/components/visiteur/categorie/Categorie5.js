...
class Categorie5 extends Component {
  constructor() {
    super();
  ...
  async getCategorie5() {
    try {
      ...
      console.log("categorie", categorie5);
    } catch (error) {
      // alert("test")
    }
  }
          ...
          <div class="container py-5" enctype="multipart/form-data">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent pl-0 mb-0">
                ...
                <li class="breadcrumb-item">
                  <a href="/categorie5">
                    Catégorie : <strong> {categorie5.nom}</strong>
                  </a>
                </li>
              </ol>
            </nav>
            ...
            {loading ? (
              ...
              <div class={"row"}>
                {this.state.categorie5.encheres.map(encheres =>
