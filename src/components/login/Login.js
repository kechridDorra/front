...
<div class="wrapper bg-white">
    ...
    <form class="pt-3" method="post" action="#" onSubmit={(e) => handleForm(e)}>
        <div class="form-group py-2">
            <div class="input-field"> <span class="far fa-user p-2"></span>
             <input type="email" placeholder="Adresse mail" id="username"
        ...
        <div class="form-group py-1 pb-2">
            <div class="input-field"> <span class="fas fa-lock p-2"></span>
             ...
             onChange={(e) => handleInput(e)} autocomplete="current-password" required="" id="password"
               class=""/>
        ...
        <div class="text-center pt-3 text-muted"> <a href="/inscription">Créer Compte</a></div>
        </form>
   </div> 
   <Footer/>
   </>   );}
