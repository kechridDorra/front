...
const AppelOffresExp = () => {
  const userInfo = localStorage.getItem("user-info");
  const [appel, setAppel] = useState({});
  async function AppelOffresExp() {
    try {
      const userApiUrl = `/appelOffresExp`;
            ...
            <ol class="breadcrumb bg-transparent pl-0 mb-0">
              ...
              <li class="breadcrumb-item">
                <a href="/appelOffresDispo">
                  <strong>Appels d'offres Expirés </strong>
                </a>
              </li>
            </ol>
          </nav><br></br>
                        ...
                        <div class="card w-100">
                          <div class="card-body">
                            <p class="mb-0">
                              ...
                              {dispo.propositions.map((el) => el.reponse)}{" "}
                            </p>
                          </div>
                        </div>
                      </li>
